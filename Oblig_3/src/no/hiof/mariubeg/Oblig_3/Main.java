package no.hiof.mariubeg.Oblig_3;

import no.hiof.mariubeg.Oblig_3.models.Planet;
import no.hiof.mariubeg.Oblig_3.models.PlanetSystem;
import no.hiof.mariubeg.Oblig_3.models.Star;
...
public class Main {
    public static void main(String[] args) {
        ...
        Planet jupiter = new Planet("Jupiter", 1.0, 1.0, 5.2044, 0.049, 4380, sun);
        Planet saturn = new Planet("Saturn", 0.8145247020645666, 0.2994204425711275, 9.5826, 0.057, 10585, sun);
        Planet uranus = new Planet("Uranus", 0.35475297935433336, 0.04573761854583773, 19.2184, 0.047, 30660, sun);
        Planet neptune = new Planet("Neptune", 0.34440217087226543, 0.05395152792413066, 30.11, 0.01, 60225, sun);
